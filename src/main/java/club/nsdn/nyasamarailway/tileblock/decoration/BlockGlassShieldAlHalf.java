 ...
 */
public class BlockGlassShieldAlHalf extends TileBlock {
    ...
    public BlockGlassShieldAlHalf() {
        super("GlassShieldAlHalf");
        setIconLocation("glass_shield_al_half");
        setLightOpacity(1);
        setLightLevel(0);
    }
    ...
    protected void setBoundsByMeta(int meta) {
        float x1 = 0.0F, y1 = 0.0F, z1 = 0.4375F, x2 = 1.0F, y2 = 0.5F, z2 = 0.5625F;
        switch (meta & 3) {
            case 0:

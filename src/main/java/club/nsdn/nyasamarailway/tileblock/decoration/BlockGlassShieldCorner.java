 ...
 */
public class BlockGlassShieldCorner extends TileBlock {
    ...
    public BlockGlassShieldCorner() {
        super("GlassShieldCorner");
        setIconLocation("glass_shield_corner");
        setLightOpacity(1);
        setLightLevel(0);
    }
    ...
    protected void setBoundsByMeta(int meta) {
        float x1 = 0.0F, y1 = 0.0F, z1 = 0.0F, x2 = 0.5625F, y2 = 1.0F, z2 = 0.5625F;
        switch (meta & 3) {
            case 0:

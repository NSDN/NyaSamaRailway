...
public class TileEntityModelBinder {
    ...
    public TileEntityModelBinder() {
        ...
        renderers.put(RailBigBumper.TileEntityRailBigBumper.class, new RailBigBumperRenderer());
        ...
        renderers.put(WireRailSwitch.TileEntityWireRailSwitch.class, new WireRailSwitchRenderer());

 ...
 */
public class PillarQuad extends TileBlock {

    public static class TileEntityPillarQuad extends TileEntityBase {

        public TileEntityPillarQuad() {
    ...
    public PillarQuad() {
        super("PillarQuad");
        setRegistryName(NyaSamaRailway.MODID, "pillar_quad");
        setLightOpacity(0);
        setLightLevel(0);
    }
    ...
    public TileEntity createNewTileEntity() {
        return new TileEntityPillarQuad();
    }
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess world, BlockPos pos) {
        ...
        if (tileEntity != null)
            if (tileEntity instanceof TileEntityPillarQuad) {
                TileEntityPillarQuad pillar = (TileEntityPillarQuad) tileEntity;
                ...
                if ((meta & PillarQuad.getValueByFacing(EnumFacing.UP)) != 0)
                    box = box.expand(0.0, 0.25, 0.0);
                if ((meta & PillarQuad.getValueByFacing(EnumFacing.DOWN)) != 0)
                    box = box.expand(0.0, -0.25, 0.0);
                if ((meta & PillarQuad.getValueByFacing(EnumFacing.NORTH)) != 0)
                    box = box.expand(0.0, 0.0, -0.25);
                if ((meta & PillarQuad.getValueByFacing(EnumFacing.SOUTH)) != 0)
                    box = box.expand(0.0, 0.0, 0.25);
                if ((meta & PillarQuad.getValueByFacing(EnumFacing.WEST)) != 0)
                    box = box.expand(-0.25, 0.0, 0.0);
                if ((meta & PillarQuad.getValueByFacing(EnumFacing.EAST)) != 0)
                    box = box.expand(0.25, 0.0, 0.0);

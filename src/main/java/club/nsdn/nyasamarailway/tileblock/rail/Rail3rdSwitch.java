 ...
 */
public class Rail3rdSwitch extends RailMonoSwitch {

    public static class MonoSwitch extends TileEntityTriStateReceiver {
    ...
    public Rail3rdSwitch() {
        super();
        setBlockName("Rail3rdSwitch");
        setIconLocation("rail_3rd_switch");
    ...
    public void doSwitch(World world, int x ,int y, int z) {
        if (world.getTileEntity(x, y, z) instanceof MonoSwitch) {
            ...
            if (old != meta) {
                ...
                world.notifyBlockChange(x, y, z, BlockLoader.rail3rd);
    ...
    public class Rail extends RailBase.Rail {
        ...
        public boolean checkBlockIsMe(World world, int x, int y, int z) {
            return world.getBlock(x, y, z).getClass() == Rail3rdSwitch.class;
        }

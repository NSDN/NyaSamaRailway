 ...
 */
public class BlockGateFront extends TileBlock {

    public static class GateFront extends club.nsdn.nyasamarailway.tileblock.signal.TileEntityGateFront {
    }

    public BlockGateFront() {
        super("GateFront");

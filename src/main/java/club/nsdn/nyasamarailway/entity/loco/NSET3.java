...
import club.nsdn.nyasamarailway.api.cart.AbsCargoLoco;
 ...
 */
public class NSET3 extends AbsCargoLoco {

    public NSET3(World world) {
        super(world);
        ignoreFrustumCheck = true;
        setSize(1.0F, 1.0F);
    }

    public NSET3(World world, double x, double y, double z) {
        super(world, x, y, z);
        ignoreFrustumCheck = true;
        setSize(1.0F, 1.0F);
    }

 ...
 */
public class NSPCT8C extends AbsLimLoco {
    ...
    public static class Container extends AbsCartBase {
        ...
        public void killMinecart(DamageSource source) {
            this.setDead();
            if (this.getRidingEntity() != null && this.getRidingEntity() instanceof NSPCT8C)
                ((NSPCT8C) this.getRidingEntity()).killMinecart(source);
        }
    ...
    private static final DataParameter<Float> SHIFT = EntityDataManager.createKey(NSPCT8C.class, DataSerializers.FLOAT);
    private static final DataParameter<Float> CNT = EntityDataManager.createKey(NSPCT8C.class, DataSerializers.FLOAT);

 ...
 */
public class NSPCT10M extends AbsLimLoco implements IHighSpeedCart, IExtendedInfoCart {
    ...
    private static final DataParameter<String> EXT = EntityDataManager.createKey(NSPCT10M.class, DataSerializers.STRING);

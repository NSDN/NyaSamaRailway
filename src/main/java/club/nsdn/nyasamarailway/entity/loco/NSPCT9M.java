 ...
 */
public class NSPCT9M extends LocoBase implements ILimitVelCart, IExtendedInfoCart {
    ...
    public NSPCT9M(World world) {
        super(world);
        ignoreFrustumCheck = true;
    }

    public NSPCT9M(World world, double x, double y, double z) {
        super(world, x, y, z);
        ignoreFrustumCheck = true;
    }
    ...
    {
        this.setDead();
        ItemStack itemstack = new ItemStack(ItemLoader.itemNSPCT9M, 1);

 ...
 */
public class NSC1A extends MinecartBase implements IMotorCart, ILimitVelCart, IExtendedInfoCart, IRotaCart {
    ...
    public NSC1A(World world) {
        super(world);
        ignoreFrustumCheck = true;
    }

    public NSC1A(World world, double x, double y, double z) {
        super(world, x, y, z);
        ignoreFrustumCheck = true;
    }
    ...
    {
        this.setDead();
        ItemStack itemstack = new ItemStack(ItemLoader.itemNSC1A, 1);

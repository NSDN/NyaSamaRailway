 ...
 */
public class NSC2BM extends LocoBase implements ILimitVelCart, IMonoRailCart {
    ...
    public NSC2BM(World world) {
        super(world);
    }

    public NSC2BM(World world, double x, double y, double z) {
        super(world, x, y, z);
    }
    ...
    {
        this.setDead();
        ItemStack itemstack = new ItemStack(ItemLoader.itemNSC2BM, 1);

 ...
 */
public class NSC3A extends MinecartBase implements IMotorCart, ILimitVelCart, IExtendedInfoCart {
    ...
    public NSC3A(World world) {
        super(world);
        ignoreFrustumCheck = true;
    }

    public NSC3A(World world, double x, double y, double z) {
        super(world, x, y, z);
        ignoreFrustumCheck = true;
    }
    ...
    {
        this.setDead();
        ItemStack itemstack = new ItemStack(ItemLoader.itemNSC3A, 1);

...
import club.nsdn.nyasamarailway.Network.NGTPacket;
...
public class GuiNGT extends GuiScreen {
    ...
    private static final ResourceLocation ngtGuiTextures = new ResourceLocation("nyasamarailway","textures/items/ngt-gui.png");
    ...
    public GuiNGT(EntityPlayer player, ItemStack stack) {

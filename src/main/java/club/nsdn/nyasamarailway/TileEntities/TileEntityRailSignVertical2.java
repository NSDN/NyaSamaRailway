 ...
 */
public class TileEntityRailSignVertical2 extends TileEntityBase {
    ...
    public TileEntityRailSignVertical2() {
        super("RailSignVertical2");
        setIconLocation("rail_sign_vertical_head_2");
        setLightOpacity(1);
        setLightLevel(0);
    }

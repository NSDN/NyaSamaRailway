...
public class TileEntityRailSignHeadJoe extends TileEntityBase {

    public static class RailSignHeadJoe extends TileEntity {}

    public TileEntityRailSignHeadJoe() {
        super("RailSignHeadJoe");
        setIconLocation("rail_sign_head_joe");
    }

    @Override
    public TileEntity createNewTileEntity(World world, int meta) {
        return new RailSignHeadJoe();
    }

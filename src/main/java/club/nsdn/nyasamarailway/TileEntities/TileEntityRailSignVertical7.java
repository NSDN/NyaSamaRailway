 ...
 */
public class TileEntityRailSignVertical7 extends TileEntityBase {
    ...
    public TileEntityRailSignVertical7() {
        super("RailSignVertical7");
        setIconLocation("rail_sign_vertical_head_7");
        setLightOpacity(1);
        setLightLevel(0);
    }

...
public class TileEntityRailSignHeadBeep extends TileEntityBase {

    public static class RailSignHeadBeep extends TileEntity {}

    public TileEntityRailSignHeadBeep() {
        super("RailSignHeadBeep");
        setIconLocation("rail_sign_head_beep");
    }

    @Override
    public TileEntity createNewTileEntity(World world, int meta) {
        return new RailSignHeadBeep();
    }

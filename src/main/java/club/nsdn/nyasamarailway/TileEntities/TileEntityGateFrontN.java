 ...
 */
public class TileEntityGateFrontN extends TileEntityBase {
    ...
    public TileEntityGateFront.GateFront getGateFront(World world, int x, int y, int z) {
        if (world.getTileEntity(x, y ,z) instanceof TileEntityGateFront.GateFront) {
            return (TileEntityGateFront.GateFront) world.getTileEntity(x, y, z);
        }
        return null;
    }

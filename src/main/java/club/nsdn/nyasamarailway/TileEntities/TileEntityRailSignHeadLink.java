...
public class TileEntityRailSignHeadLink extends TileEntityBase {

    public static class RailSignHeadLink extends TileEntity {}

    public TileEntityRailSignHeadLink() {
        super("RailSignHeadLink");
        setIconLocation("rail_sign_head_link");
    }

    @Override
    public TileEntity createNewTileEntity(World world, int meta) {
        return new RailSignHeadLink();
    }

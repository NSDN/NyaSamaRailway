 ...
 */
public class RailMonoMagnetDirectional extends RailMonoMagnetBase implements IRailDirectional {
    ...
    public RailMonoMagnetDirectional() {
        super(true, "RailMonoMagnetDirectional", "rail_mono_magnet_directional");
    }

...
import club.nsdn.nyasamarailway.Blocks.IRailNoDelay;
 ...
 */
public class RailMonoMagnetSniffer extends RailMonoMagnetDetector implements IRailNoDelay {

    public static class RailSniffer extends TileEntityRailSniffer implements RailMonoMagnetPowerable {
    ...
    public RailMonoMagnetSniffer() {
        super("RailMonoMagnetSniffer", "rail_mono_magnet_sniffer");
    }

 ...
 */
public class TileEntityRailSignVertical5 extends TileEntityBase {
    ...
    public TileEntityRailSignVertical5() {
        super("RailSignVertical5");
        setIconLocation("rail_sign_vertical_head_5");
        setLightOpacity(1);
        setLightLevel(0);
    }

 ...
 */
public class TileEntityRailSignVertical1 extends TileEntityBase {
    ...
    public TileEntityRailSignVertical1() {
        super("RailSignVertical1");
        setIconLocation("rail_sign_vertical_head_1");
        setLightOpacity(1);
        setLightLevel(0);
    }

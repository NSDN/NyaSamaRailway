 ...
 */
public class TileEntityRailSignVertical4 extends TileEntityBase {
    ...
    public TileEntityRailSignVertical4() {
        super("RailSignVertical4");
        setIconLocation("rail_sign_vertical_head_4");
        setLightOpacity(1);
        setLightLevel(0);
    }

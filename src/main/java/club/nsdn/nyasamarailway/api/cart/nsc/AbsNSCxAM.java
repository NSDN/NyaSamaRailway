...
public abstract class AbsNSCxAM extends AbsLimLoco implements IExtendedInfoCart {
    ...
    private static final DataParameter<String> EXT = EntityDataManager.createKey(AbsNSCxAM.class, DataSerializers.STRING);
    ...
    public AbsNSCxAM(World world) {
        super(world);
        ignoreFrustumCheck = true;
    }

    public AbsNSCxAM(World world, double x, double y, double z) {
        super(world, x, y, z);
        ignoreFrustumCheck = true;
    }

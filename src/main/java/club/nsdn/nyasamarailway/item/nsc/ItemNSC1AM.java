...
import club.nsdn.nyasamarailway.entity.nsc.NSC1AM;
 ...
 */
public class ItemNSC1AM extends AbsItemCart {

    public ItemNSC1AM() {
        super(NSC1AM.class, "ItemNSC1AM", "item_nsc_1am");
    ...
    public void selfSpawn(World world, double x, double y, double z, String name, EntityPlayer player) {
        NSC1AM cart = new NSC1AM(world, x, y, z);

...
import club.nsdn.nyasamarailway.TileEntities.TileEntityGateDoor;
import club.nsdn.nyasamarailway.TileEntities.TileEntityGateFront;
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        switch (renderType) {
            ...
            case GATE_FRONT_N:
                ...
                break;
            case GATE_FRONT:
                if (te instanceof TileEntityGateFront.GateFront) {
                    boolean isEnabled = ((TileEntityGateFront.GateFront) te).isEnabled;
                    int over = ((TileEntityGateFront.GateFront) te).over;

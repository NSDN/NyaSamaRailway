...
public class BaseRenderer extends TileEntitySpecialRenderer {
    ...
    private void adjustLightFixture(World world, double i, double j, double k, Block block) {
        Tessellator tess = Tessellator.instance;
        float brightness = block.getLightOpacity(world, (int) i, (int) j, (int) k);
        int skyLight = world.getLightBrightnessForSkyBlocks((int) i, (int) j, (int) k, 0);

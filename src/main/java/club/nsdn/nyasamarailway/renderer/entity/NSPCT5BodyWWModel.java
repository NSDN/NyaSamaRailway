...
public class NSPCT5BodyWWModel extends ModelBase {
    ...
    public NSPCT5BodyWWModel() {
        textureWidth = 128;
        textureHeight = 32;
        setTextureOffset("Piece1.ShapeA", 0, 0);
        setTextureOffset("Piece1.ShapeB", 0, 0);
        setTextureOffset("Piece1.ShapeC", 0, 0);
        setTextureOffset("Piece1.ShapeD", 0, 0);
        setTextureOffset("Piece1.ShapeE", 50, 16);
        setTextureOffset("Piece2.ShapeA", 0, 0);
        setTextureOffset("Piece2.ShapeB", 0, 0);
        setTextureOffset("Piece2.ShapeC", 0, 0);
        setTextureOffset("Piece2.ShapeD", 0, 0);
        setTextureOffset("Piece2.ShapeE", 50, 16);
        ...
        Piece1.mirror = true;
        Piece1.addBox("ShapeA", 0F, 0F, 3F, 2, 2, 10);
        Piece1.addBox("ShapeB", 0F, 8F, 3F, 2, 2, 10);
        Piece1.addBox("ShapeC", 0F, 0F, 0F, 2, 10, 3);
        Piece1.addBox("ShapeD", 0F, 0F, 13F, 2, 10, 3);
        Piece1.addBox("ShapeE", 1F, 2F, 3F, 0, 6, 10);
        Piece2 = new ModelRenderer(this, "Piece2");
        Piece2.setRotationPoint(10F, -6.9F, -8F);
        setRotation(Piece2, 0F, 0F, 0F);
        Piece2.mirror = true;
        Piece2.addBox("ShapeA", 0F, 0F, 3F, 2, 2, 10);
        Piece2.addBox("ShapeB", 0F, 8F, 3F, 2, 2, 10);
        Piece2.addBox("ShapeC", 0F, 0F, 0F, 2, 10, 3);
        Piece2.addBox("ShapeD", 0F, 0F, 13F, 2, 10, 3);
        Piece2.addBox("ShapeE", 1F, 2F, 3F, 0, 6, 10);
    }

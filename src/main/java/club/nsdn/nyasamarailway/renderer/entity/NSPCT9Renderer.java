 ...
 */
public class NSPCT9Renderer extends AbsCartRenderer {

    public static IRenderFactory<EntityMinecart> FACTORY = NSPCT9Renderer::new;
    ...
    public NSPCT9Renderer(RenderManager manager) {
        super(manager);

 ...
 */
public class NSBT3Renderer extends AbsCartRenderer {

    public static IRenderFactory<EntityMinecart> FACTORY = NSBT3Renderer::new;

    private final String _name = "nsb_3";
    ...
    public NSBT3Renderer(RenderManager manager) {
        super(manager);
    }
    ...
    public void render(EntityMinecart cart, double x, double y, double z, float yaw) {
        ...
        float angle = 0.0F;
        if (cart instanceof NSBT3) {
            angle = ((NSBT3) cart).angle;
        }

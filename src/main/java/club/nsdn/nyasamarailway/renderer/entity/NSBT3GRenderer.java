 ...
 */
public class NSBT3GRenderer extends AbsCartRenderer {

    public static IRenderFactory<EntityMinecart> FACTORY = NSBT3GRenderer::new;

    private final String _name = "nsb_3g";
    ...
    public NSBT3GRenderer(RenderManager manager) {
        super(manager);
    }
    ...
    public void render(EntityMinecart cart, double x, double y, double z, float yaw) {
        ...
        float angle = 0.0F;
        if (cart instanceof NSBT3G) {
            angle = ((NSBT3G) cart).angle;
        }

 ...
 */
public class NSRM3Renderer extends AbsTrainRenderer {

    public static IRenderFactory<AbsTrainBase> FACTORY = NSRM3Renderer::new;

    private final String _name = "nsr_m3";
    ...
    public NSRM3Renderer(RenderManager manager) {
        super(manager);
    }
    ...
    public void render(AbsTrainBase train, double x, double y, double z, float yaw) {
        ...
        if (train instanceof NSRM3) {
            NSRM3 metro = (NSRM3) train;

 ...
 */
public class NSBT2MRenderer extends AbsCartRenderer {

    public static IRenderFactory<EntityMinecart> FACTORY = NSBT2MRenderer::new;

    private final String _name = "nsb_2m";
    ...
    public NSBT2MRenderer(RenderManager manager) {
        super(manager);
    }
    ...
    public void render(EntityMinecart cart, double x, double y, double z, float yaw) {
        ...
        float angle = 0.0F;
        if (cart instanceof NSBT2M) {
            angle = ((NSBT2M) cart).angle;
        }

 ...
 */
public class NSBT5MRenderer extends AbsCartRenderer {

    public static IRenderFactory<EntityMinecart> FACTORY = NSBT5MRenderer::new;
    ...
    public NSBT5MRenderer(RenderManager manager) {
        super(manager);
    }

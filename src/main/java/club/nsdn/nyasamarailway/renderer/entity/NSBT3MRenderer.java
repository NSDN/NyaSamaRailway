 ...
 */
public class NSBT3MRenderer extends AbsCartRenderer {

    public static IRenderFactory<EntityMinecart> FACTORY = NSBT3MRenderer::new;

    private final String _name = "nsb_3m";
    ...
    public NSBT3MRenderer(RenderManager manager) {
        super(manager);
    }
    ...
    public void render(EntityMinecart cart, double x, double y, double z, float yaw) {
        ...
        float angle = 0.0F;
        if (cart instanceof NSBT3M) {
            angle = ((NSBT3M) cart).angle;
        }

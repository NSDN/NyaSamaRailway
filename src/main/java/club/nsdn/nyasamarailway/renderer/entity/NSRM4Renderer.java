 ...
 */
public class NSRM4Renderer extends AbsTrainRenderer {

    public static IRenderFactory<AbsTrainBase> FACTORY = NSRM4Renderer::new;

    private final String _name = "nsr_m4";
    ...
    public NSRM4Renderer(RenderManager manager) {
        super(manager);
    }
    ...
    public void render(AbsTrainBase train, double x, double y, double z, float yaw) {
        ...
        if (train instanceof NSRM4) {
            NSRM4 metro = (NSRM4) train;

 ...
 */
public class NSPCT10Renderer extends RenderMinecart {
    ...
    private final String _screen = "nspc_10j";
    ...
    private void doRenderHUD(EntityMinecart cart) {
        if (cart instanceof NSPCT10) {
            NSPCT10 loco = (NSPCT10) cart;

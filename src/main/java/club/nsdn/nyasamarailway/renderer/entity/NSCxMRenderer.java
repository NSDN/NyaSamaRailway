...
public class NSCxMRenderer extends AbsCartRenerer {
    ...
    public static IRenderFactory<EntityMinecart> FACTORY_2A = (RenderManager manager) -> new NSCxMRenderer(manager, "nsc_2am", true);
    public static IRenderFactory<EntityMinecart> FACTORY_2B = (RenderManager manager) -> new NSCxMRenderer(manager, "nsc_2bm", true);
    public static IRenderFactory<EntityMinecart> FACTORY_3A = (RenderManager manager) -> new NSCxMRenderer(manager, "nsc_3am", false);
    public static IRenderFactory<EntityMinecart> FACTORY_3B = (RenderManager manager) -> new NSCxMRenderer(manager, "nsc_3bm", false);
    ...
    private final WavefrontObject modelJet = new WavefrontObject(
            new ResourceLocation("nyasamarailway", "models/carts/" + "nspc_9m" + "_jet.obj")
    );
    ...
    public NSCxMRenderer(RenderManager manager, String name, boolean hasPrint) {
        super(manager);

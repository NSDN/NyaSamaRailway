 ...
 */
public class NSRM2GRenderer extends AbsTrainRenderer {

    public static IRenderFactory<AbsTrainBase> FACTORY = NSRM2GRenderer::new;

    private final String _name = "nsr_m2g";
    ...
    public NSRM2GRenderer(RenderManager manager) {
        super(manager);
    }
    ...
    public void render(AbsTrainBase train, double x, double y, double z, float yaw) {
        ...
        if (train instanceof NSRM2G) {
            NSRM2G metro = (NSRM2G) train;

            GlStateManager.enableAlpha();
            GlStateManager.enableBlend();
            modelBase.renderOnly("w0", "w1", "w2", "w3", "w4", "w5");

            double prog = metro.doorProgressRight / 100.0 * 30;
            GlStateManager.pushMatrix();
            ...
            prog = metro.doorProgressLeft / 100.0 * 30;
            GlStateManager.pushMatrix();
            GlStateManager.translate(prog, 0, 0);
            GlStateManager.enableAlpha();
            GlStateManager.enableBlend();

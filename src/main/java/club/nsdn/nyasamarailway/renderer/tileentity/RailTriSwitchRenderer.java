...
public class RailTriSwitchRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        if (te instanceof RailTriSwitch.TriSwitch) {
            RailTriSwitch.TriSwitch triSwitch = (RailTriSwitch.TriSwitch) te;
            ...
            switch (triSwitch.prevState) {
                case RailTriSwitch.TriSwitch.STATE_POS:
                    direction = TURNED_L;
                    break;
                case RailTriSwitch.TriSwitch.STATE_NEG:
                    direction = TURNED_R;
                    break;
                case RailTriSwitch.TriSwitch.STATE_ZERO:
                    direction = STRAIGHT;
                    break;
            }

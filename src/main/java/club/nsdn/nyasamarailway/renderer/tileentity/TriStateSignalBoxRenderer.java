...
public class TriStateSignalBoxRenderer extends TileEntitySpecialRenderer {
    ...
    private final ResourceLocation textureBase = new ResourceLocation("nyasamarailway", "textures/blocks/tri_state_signal_box_base.png");
    ...
    private final WavefrontObject models[] = {
            ...
            new WavefrontObject(new ResourceLocation("nyasamarailway", "models/blocks/signal_box_sign4.obj"))
    };
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        if (te instanceof BlockTriStateSignalBox.TileEntityTriStateSignalBox) {
            txState = ((BlockTriStateSignalBox.TileEntityTriStateSignalBox) te).getTarget() != null;
            rxState = ((BlockTriStateSignalBox.TileEntityTriStateSignalBox) te).getSender() != null;
            inverted = ((BlockTriStateSignalBox.TileEntityTriStateSignalBox) te).inverterEnabled;
            triStateIsNeg = ((BlockTriStateSignalBox.TileEntityTriStateSignalBox) te).triStateIsNeg;
        }
